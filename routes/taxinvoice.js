...
router.get('/getInfos', function (req, res, next) {
    ...
    // 문서번호 배열, 최대 1000건
    var mgtKeyList = ['20201123-001', '20201123-003'];

...
router.get( '/paymentRequest', function ( req, res, next ) {
	...
	taxinvoiceService.paymentRequest( CorpNUm, PaymentForm, UserID,
		function ( result ) {
...
router.get( '/getSettleResult', function ( req, res, next ) {
	...
	taxinvoiceService.getBulkResult( CorpNum, SettleCode, UserID,
		function ( result ) {
...
router.get( '/refund', function ( req, res, next ) {
	...
	taxinvoiceService.refund( CorpNum, RefundForm, UserID,
		function ( result ) {
			res.render( 'response', {
				path      : req.path,
				code      : result.code,
...
router.get( '/getRefundHistory', function ( req, res, next ) {
	...
	taxinvoiceService.getRefundHistory( CorpNum, Page, PerPage, UserID,
		function ( result ) {
...
router.get( '/quitMember', function ( req, res, next ) {
	...
	taxinvoiceService.QuitMember( CorpNum, QuitReason, UserID, function ( result ) {
		res.render( 'response', {
...
router.get( '/getRefundableBalance', function ( req, res, next ) {
	...
	taxinvoiceService.GetRefundableBalance( CorpNum, UserID, function ( result ) {
...
router.get( '/getRefundInfo', function ( req, res, next ) {
	...
	taxinvoiceService.GetRefundInfo( CorpNum, RefundCode, UserID, function ( result ) {

...
router.get( '/cancelReservebyRCV', function ( req, res, next ) {
	...
	kakaoService.cancelReservebyRCV( CorpNum, receiptNum, receiveNum, UserID,
		function ( result ) {
...
router.get( '/paymentRequest', function ( req, res, next ) {
	...
	kakaoService.paymentRequest( CorpNUm, PaymentForm, UserID,
		function ( result ) {
...
router.get( '/getSettleResult', function ( req, res, next ) {
	...
	kakaoService.getBulkResult( CorpNum, SettleCode, UserID,
		function ( result ) {
...
router.get( '/refund', function ( req, res, next ) {
	...
	kakaoService.refund( CorpNum, RefundForm, UserID,
		function ( result ) {
			res.render( 'response', {
				path      : req.path,
				code      : result.code,
...
router.get( '/getRefundHistory', function ( req, res, next ) {
	...
	kakaoService.getRefundHistory( CorpNum, Page, PerPage, UserID,
		function ( result ) {
...
/**
 * 회원 탈퇴를 합니다.
 * https://developers.popbill.com/reference/kakaotalk/node/api/point#QuitMember
 */
router.get( '/quitMember', function ( req, res, next ) {
	...
	kakaoService.QuitMember( CorpNum, QuitReason, UserID, function ( result ) {
		res.render( 'response', {
...
router.get( '/getRefundableBalance', function ( req, res, next ) {
	...
	kakaoService.GetRefundableBalance( CorpNum, UserID, function ( result ) {
...
router.get( '/getRefundInfo', function ( req, res, next ) {
	...
	kakaoService.GetRefundInfo( CorpNum, RefundCode, UserID, function ( result ) {

...
router.get( '/quitMember', function ( req, res, next ) {
	...
	bizInfoCheckService.QuitMember( CorpNum, QuitReason, UserID, function ( result ) {
		res.render( 'response', {
...
router.get( '/getRefundableBalance', function ( req, res, next ) {
	...
	bizInfoCheckService.GetRefundableBalance( CorpNum, UserID, function ( result ) {
...
router.get( '/getRefundInfo', function ( req, res, next ) {
	...
	bizInfoCheckService.GetRefundInfo( CorpNum, RefundCode, UserID, function ( result ) {

 ...
 * - https://developers.popbill.com/reference/easyfinbank/node/common-api/member#CheckIsMember
 */
 ...
 * - https://developers.popbill.com/reference/easyfinbank/node/common-api/member#CheckID
 */
...
router.get("/DeleteContact", function (req, res, next) {
    ...
    easyFinBankService.deleteContact(
        CorpNum,
        TargetUserID,
        UserID,
        function (result) {

 ...
 * - https://developers.popbill.com/reference/accountcheck/node/common-api/member#CheckIsMember
 */
 ...
 * - https://developers.popbill.com/reference/accountcheck/node/common-api/member#CheckID
 */
...
/**
 * 사용자를 연동회원으로 가입처리합니다.
 * - https://developers.popbill.com/reference/accountcheck/node/common-api/member#JoinMember
 */
...
router.get("/DeleteContact", function (req, res, next) {
    ...
    accountCheckService.deleteContact(
        CorpNum,
        TargetUserID,
        UserID,
        function (result) {

...
router.get( '/checkAccountInfo', function ( req, res, next ) {
	...
	accountCheckService.checkAccountInfo( testCorpNum, bankCode, accountNumber, function ( returnObj ) {
		res.render( 'AccountCheck/CheckAccountInfo', {
			path: req.path, result: returnObj,
		} );
	}, function ( Error ) {
		res.render( 'response', {
...
router.get( '/checkDepositorInfo', function ( req, res, next ) {
	...
	accountCheckService.checkDepositorInfo( testCorpNum, bankCode, accountNumber, identityNumType, identityNum, function ( returnObj ) {
...
router.get( '/getBalance', function ( req, res, next ) {
	...
	accountCheckService.getBalance( testCorpNum, function ( remainPoint ) {
		res.render( 'result', {
...
router.get( '/getChargeURL', function ( req, res, next ) {
	...
	accountCheckService.getChargeURL( testCorpNum, testUserID, function ( url ) {
		res.render( 'result', {
...
router.get( '/getPaymentURL', function ( req, res, next ) {
	...
	accountCheckService.getPaymentURL( testCorpNum, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getUseHistoryURL', function ( req, res, next ) {
	...
	accountCheckService.getUseHistoryURL( testCorpNum, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getPartnerBalance', function ( req, res, next ) {
	...
	accountCheckService.getPartnerBalance( testCorpNum, function ( remainPoint ) {
		res.render( 'result', {
			path: req.path, result: remainPoint,
		} );
	}, function ( Error ) {
...
router.get( '/getPartnerURL', function ( req, res, next ) {
	...
	accountCheckService.getPartnerURL( testCorpNum, TOGO, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getUnitCost', function ( req, res, next ) {
	...
	accountCheckService.getUnitCost( testCorpNum, serviceType, function ( unitCost ) {
		res.render( 'result', {
...
router.get( '/getChargeInfo', function ( req, res, next ) {
	...
	accountCheckService.getChargeInfo( testCorpNum, serviceType, userId, function ( result ) {
...
router.get( '/checkIsMember', function ( req, res, next ) {
	...
	accountCheckService.checkIsMember( testCorpNum, function ( result ) {
		res.render( 'response', {
...
router.get( '/checkID', function ( req, res, next ) {
	...
	accountCheckService.checkID( testID, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/joinMember', function ( req, res, next ) {
	...
	accountCheckService.joinMember( joinInfo, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/getAccessURL', function ( req, res, next ) {
	...
	accountCheckService.getAccessURL( testCorpNum, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getCorpInfo', function ( req, res, next ) {
	...
	accountCheckService.getCorpInfo( testCorpNum, function ( result ) {
...
router.get( '/updateCorpInfo', function ( req, res, next ) {
	...
	accountCheckService.updateCorpInfo( testCorpNum, corpInfo, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/registContact', function ( req, res, next ) {
	...
	accountCheckService.registContact( testCorpNum, contactInfo, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/getContactInfo', function ( req, res, next ) {
	...
	accountCheckService.getContactInfo( testCorpNum, contactID, function ( result ) {
...
router.get( '/listContact', function ( req, res, next ) {
	...
	accountCheckService.listContact( testCorpNum, function ( result ) {
...
router.get( '/updateContact', function ( req, res, next ) {
	...
	accountCheckService.updateContact( testCorpNum, testUserID, contactInfo, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/paymentRequest', function ( req, res, next ) {
	...
	accountCheckService.paymentRequest( CorpNUm, PaymentForm, UserID, function ( result ) {
...
router.get( '/getSettleResult', function ( req, res, next ) {
	...
	accountCheckService.getBulkResult( CorpNum, SettleCode, UserID, function ( result ) {
...
router.get( '/getPaymentHistory', function ( req, res, next ) {
	...
	accountCheckService.getPaymentHistory( CorpNum, SDate, EDate, Page, PerPage, UserID, function ( result ) {
...
router.get( '/getUseHistory', function ( req, res, next ) {
	...
	accountCheckService.getUseHistory( CorpNum, SDate, EDate, Page, PerPage, Order, UserID, function ( result ) {
...
router.get( '/getRefundHistory', function ( req, res, next ) {
	...
	accountCheckService.getRefundHistory( CorpNum, Page, PerPage, UserID, function ( result ) {
...
router.get( '/quitMember', function ( req, res, next ) {
	...
	accountCheckService.QuitMember( CorpNum, QuitReason, UserID, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/getRefundableBalance', function ( req, res, next ) {
	...
	accountCheckService.GetRefundableBalance( CorpNum, UserID, function ( result ) {
...
router.get( '/getRefundInfo', function ( req, res, next ) {
	...
	accountCheckService.GetRefundInfo( CorpNum, RefundCode, UserID, function ( result ) {

...
router.get( '/checkSenderNumber', function ( req, res, next ) {
	...
	messageService.checkSenderNumber( testCorpNum, senderNumber,
		function ( result ) {
			res.render( 'response', {
				path   : req.path,
				code   : result.code,
...
router.get( '/paymentRequest', function ( req, res, next ) {
	...
	messageService.paymentRequest( CorpNUm, PaymentForm, UserID,
		function ( result ) {
...
router.get( '/getSettleResult', function ( req, res, next ) {
	...
	messageService.getBulkResult( CorpNum, SettleCode, UserID,
		function ( result ) {
...
router.get( '/refund', function ( req, res, next ) {
	...
	messageService.refund( CorpNum, RefundForm, UserID,
		function ( result ) {
			res.render( 'response', {
				path      : req.path,
				code      : result.code,
...
router.get( '/getRefundHistory', function ( req, res, next ) {
	...
	messageService.getRefundHistory( CorpNum, Page, PerPage, UserID,
		function ( result ) {
...
/**
 * 회원 탈퇴를 합니다.
 * https://developers.popbill.com/reference/sms/node/api/point#QuitMember
 */
router.get( '/quitMember', function ( req, res, next ) {
	...
	messageService.QuitMember( CorpNum, QuitReason, UserID, function ( result ) {
		res.render( 'response', {
...
router.get( '/getRefundableBalance', function ( req, res, next ) {
	...
	messageService.GetRefundableBalance( CorpNum, UserID, function ( result ) {
...
router.get( '/getRefundInfo', function ( req, res, next ) {
	...
	messageService.GetRefundInfo( CorpNum, RefundCode, UserID, function ( result ) {

...
router.get( '/refund', function ( req, res, next ) {
	...
	htTaxinvoiceService.refund( CorpNum, RefundForm, UserID,
		function ( result ) {
			res.render( 'response', {
				path      : req.path,
				code      : result.code,
...
/**
 * 회원 탈퇴를 합니다.
 * https://developers.popbill.com/reference/httaxinvoice/node/api/point#QuitMember
 */
router.get( '/quitMember', function ( req, res, next ) {
	...
	htTaxinvoiceService.QuitMember( CorpNum, QuitReason, UserID, function ( result ) {
		res.render( 'response', {
...
router.get( '/getRefundableBalance', function ( req, res, next ) {
	...
	htTaxinvoiceService.GetRefundableBalance( CorpNum, UserID, function ( result ) {
...
router.get( '/getRefundInfo', function ( req, res, next ) {
	...
	htTaxinvoiceService.GetRefundInfo( CorpNum, RefundCode, UserID, function ( result ) {

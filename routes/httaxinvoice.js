/**
  * 팝빌 홈택스 전자세금계산서 API Node SDK Example
  *
  * Node 연동 튜토리얼 안내 : https://developers.popbill.com/guide/httaxinvoice/node/getting-started/tutorial
 ...
 * - https://developers.popbill.com/reference/httaxinvoice/node/common-api/member#CheckIsMember
 */
...
/**
 * 사용자를 연동회원으로 가입처리합니다.
 * - https://developers.popbill.com/reference/httaxinvoice/node/common-api/member#JoinMember
 */
...
router.get("/DeleteContact", function (req, res, next) {
    ...
    htTaxinvoiceService.deleteContact(
        CorpNum,
        TargetUserID,
        UserID,
        function (result) {

...
router.get( '/getPaymentURL', function ( req, res, next ) {
	...
	closedownService.getPaymentURL( testCorpNum, testUserID,
		function ( url ) {
			res.render( 'result', {
				path  : req.path,
				result: url,
...
router.get( '/getUseHistoryURL', function ( req, res, next ) {
	...
	closedownService.getUseHistoryURL( testCorpNum, testUserID,
		function ( url ) {
			res.render( 'result', {
				path  : req.path,
				result: url,
...
router.get( '/getContactInfo', function ( req, res, next ) {
	...
	closedownService.getContactInfo( testCorpNum, contactID,
		function ( result ) {
...
router.get( '/paymentRequest', function ( req, res, next ) {
	...
	closedownService.paymentRequest( CorpNUm, PaymentForm, UserID,
		function ( result ) {
...
router.get( '/getSettleResult', function ( req, res, next ) {
	...
	closedownService.getBulkResult( CorpNum, SettleCode, UserID,
		function ( result ) {
...
router.get( '/refund', function ( req, res, next ) {
	...
	closedownService.refund( CorpNum, RefundForm, UserID,
		function ( result ) {
			res.render( 'response', {
				path  : req.path,
				code: result.code,
...
router.get( '/getRefundHistory', function ( req, res, next ) {
	...
	closedownService.getRefundHistory( CorpNum, Page, PerPage, UserID,
		function ( result ) {

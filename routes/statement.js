...
router.get('/getSealURL', function (req, res, next) {
    ...
    statementService.getSealURL(testCorpNum, testUserID,
        function (url) {
            res.render('result', {
                path: req.path,
                result: url
...
router.get('/getPaymentURL', function (req, res, next) {
    ...
    statementService.getPaymentURL(testCorpNum, testUserID,
        function (url) {
            res.render('result', {
                path: req.path,
                result: url
...
router.get('/getUseHistoryURL', function (req, res, next) {
    ...
    statementService.getUseHistoryURL(testCorpNum, testUserID,
        function (url) {
            res.render('result', {
                path: req.path,
                result: url
...
router.get('/getContactInfo', function (req, res, next) {
    ...
    statementService.getContactInfo(testCorpNum, contactID,
        function (result) {
...
router.get('/paymentRequest', function (req, res, next) {
    ...
    statementService.paymentRequest(CorpNUm, PaymentForm, UserID,
        function (result) {
...
router.get('/getSettleResult', function (req, res, next) {
    ...
    statementService.getBulkResult(CorpNum, SettleCode, UserID,
        function (result) {
...
router.get('/refund', function (req, res, next) {
    ...
    statementService.refund(CorpNum, RefundForm, UserID,
        function (result) {
            res.render('response', {
                path: req.path,
                result: result
...
router.get('/getRefundHistory', function (req, res, next) {
    ...
    statementService.getRefundHistory(CorpNum, Page, PerPage, UserID,
        function (result) {

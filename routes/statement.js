...
router.get( '/checkMgtKeyInUse', function ( req, res, next ) {
	...
	statementService.checkMgtKeyInUse( testCorpNum, itemCode, mgtKey, function ( result ) {
		res.render( 'result', {
			path: req.path, result: '사용중',
		} );
	}, function ( Error ) {
		res.render( 'response', {
			path: req.path, code: Error.code, message: Error.message,
		} );
	} );
} );
...
router.get( '/registIssue', function ( req, res, next ) {
	...
	var statement = {
		...
		// 기재 상 '비고' 항목
		remark1: '비고1', remark2: '비고2', remark3: '비고3',
		...
		detailList: [
			{
				...
				itemName  : '품명', purchaseDT: '20220629', // 구매일자
				qty       : '1', // 수량
				unitCost  : '10000', // 단가
				spec      : '규격', // 규격
			...
			},
			{
				...
				itemName  : '품명2', purchaseDT: '20220629', // 구매일자
				qty       : '1', // 수량
				unitCost  : '10000', // 단가
				spec      : '규격', // 규격
				supplyCost: '10000', // 공급가액
	...
	statementService.registIssue( testCorpNum, statement, memo, testUserID, emailSubject, function ( result ) {
		res.render( 'Statement/IssueResponse', {
			path: req.path, code: result.code, message: result.message, invoiceNum: result.invoiceNum,
		} );
	}, function ( Error ) {
		res.render( 'response', {
			path: req.path, code: Error.code, message: Error.message,
...
router.get( '/register', function ( req, res, next ) {
	...
	statementService.register( testCorpNum, statement, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
		res.render( 'response', {
			path: req.path, code: Error.code, message: Error.message,
...
router.get( '/update', function ( req, res, next ) {
	...
	statementService.update( testCorpNum, ItemCode, MgtKey, statement, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/issue', function ( req, res, next ) {
	...
	statementService.issue( testCorpNum, itemCode, mgtKey, memo, EmailSubject, UserID, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/cancelIssue', function ( req, res, next ) {
	...
	statementService.cancel( testCorpNum, itemCode, mgtKey, memo, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/delete', function ( req, res, next ) {
	...
	statementService.delete( testCorpNum, itemCode, mgtKey, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/getInfo', function ( req, res, next ) {
	...
	statementService.getInfo( testCorpNum, itemCode, mgtKey, function ( result ) {
		res.render( 'Statement/StatementInfo', {
			path: req.path, result: result,
		} );
	}, function ( Error ) {
		res.render( 'response', {
			path: req.path, code: Error.code, message: Error.message,
...
router.get( '/getInfos', function ( req, res, next ) {
	...
	statementService.getInfos( testCorpNum, itemCode, mgtKeyList, function ( result ) {
...
router.get( '/getDetailInfo', function ( req, res, next ) {
	...
	statementService.getDetailInfo( testCorpNum, itemCode, mgtKey, function ( result ) {
...
router.get( '/search', function ( req, res, next ) {
	...
	statementService.search( testCorpNum, DType, SDate, EDate, State, ItemCode, QString, Order, Page, PerPage, function ( result ) {
...
router.get( '/getLogs', function ( req, res, next ) {
	...
	statementService.getLogs( testCorpNum, itemCode, mgtKey, function ( result ) {
...
router.get( '/getURL', function ( req, res, next ) {
	...
	statementService.getURL( testCorpNum, TOGO, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
		res.render( 'response', {
			path: req.path, code: Error.code, message: Error.message,
...
router.get( '/getPopUpURL', function ( req, res, next ) {
	...
	statementService.getPopUpURL( testCorpNum, itemCode, mgtKey, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getViewURL', function ( req, res, next ) {
	...
	statementService.getViewURL( testCorpNum, itemCode, mgtKey, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getPrintURL', function ( req, res, next ) {
	...
	statementService.getPrintURL( testCorpNum, itemCode, mgtKey, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getEPrintURL', function ( req, res, next ) {
	...
	statementService.getEPrintURL( testCorpNum, itemCode, mgtKey, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getMassPrintURL', function ( req, res, next ) {
	...
	statementService.getMassPrintURL( testCorpNum, itemCode, mgtKeyList, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getMailURL', function ( req, res, next ) {
	...
	statementService.getMailURL( testCorpNum, itemCode, mgtKey, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getAccessURL', function ( req, res, next ) {
	...
	statementService.getAccessURL( testCorpNum, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getSealURL', function ( req, res, next ) {
	...
	statementService.getSealURL( testCorpNum, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/attachFile', function ( req, res, next ) {
	...
	statementService.attachFile( testCorpNum, itemCode, mgtKey, fileName, filePaths, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/deleteFile', function ( req, res, next ) {
	...
	statementService.deleteFile( testCorpNum, itemCode, mgtKey, fileID, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/getFiles', function ( req, res, next ) {
	...
	statementService.getFiles( testCorpNum, itemCode, mgtKey, function ( result ) {
...
router.get( '/sendEmail', function ( req, res, next ) {
	...
	statementService.sendEmail( testCorpNum, itemCode, mgtKey, receiver, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/sendSMS', function ( req, res, next ) {
	...
	statementService.sendSMS( testCorpNum, itemCode, mgtKey, senderNum, receiverNum, contents, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/sendFAX', function ( req, res, next ) {
	...
	statementService.sendFAX( testCorpNum, itemCode, mgtKey, senderNum, receiverNum, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/FAXSend', function ( req, res, next ) {
	...
	statementService.FAXSend( testCorpNum, statement, sendNum, receiveNum, function ( receiptNum ) {
		res.render( 'result', {
			path: req.path, result: receiptNum,
		} );
	}, function ( Error ) {
		res.render( 'response', {
			path: req.path, code: Error.code, message: Error.message,
...
router.get( '/attachStatement', function ( req, res, next ) {
	...
	statementService.attachStatement( testCorpNum, itemCode, mgtKey, subItemCode, subMgtKey, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/detachStatement', function ( req, res, next ) {
	...
	statementService.detachStatement( testCorpNum, itemCode, mgtKey, subItemCode, subMgtKey, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/listEmailConfig', function ( req, res, next ) {
	...
	statementService.listEmailConfig( testCorpNum, function ( result ) {
...
router.get( '/updateEmailConfig', function ( req, res, next ) {
	...
	statementService.updateEmailConfig( testCorpNum, emailType, sendYN, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/getBalance', function ( req, res, next ) {
	...
	statementService.getBalance( testCorpNum, function ( remainPoint ) {
		res.render( 'result', {
			path: req.path, result: remainPoint,
		} );
	}, function ( Error ) {
		res.render( 'response', {
			path: req.path, code: Error.code, message: Error.message,
...
router.get( '/getChargeURL', function ( req, res, next ) {
	...
	statementService.getChargeURL( testCorpNum, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getPaymentURL', function ( req, res, next ) {
	...
	statementService.getPaymentURL( testCorpNum, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getUseHistoryURL', function ( req, res, next ) {
	...
	statementService.getUseHistoryURL( testCorpNum, testUserID, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getPartnerBalance', function ( req, res, next ) {
	...
	statementService.getPartnerBalance( testCorpNum, function ( remainPoint ) {
		res.render( 'result', {
			path: req.path, result: remainPoint,
		} );
	}, function ( Error ) {
...
router.get( '/getPartnerURL', function ( req, res, next ) {
	...
	statementService.getPartnerURL( testCorpNum, TOGO, function ( url ) {
		res.render( 'result', {
			path: req.path, result: url,
		} );
	}, function ( Error ) {
...
router.get( '/getUnitCost', function ( req, res, next ) {
	...
	statementService.getUnitCost( testCorpNum, itemCode, function ( unitCost ) {
		res.render( 'result', {
			path: req.path, result: unitCost,
		} );
	}, function ( Error ) {
		res.render( 'response', {
			path: req.path, code: Error.code, message: Error.message,
...
router.get( '/getChargeInfo', function ( req, res, next ) {
	...
	statementService.getChargeInfo( testCorpNum, itemCode, function ( result ) {
...
router.get( '/checkIsMember', function ( req, res, next ) {
	...
	statementService.checkIsMember( testCorpNum, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/checkID', function ( req, res, next ) {
	...
	statementService.checkID( testID, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/joinMember', function ( req, res, next ) {
	...
	statementService.joinMember( joinInfo, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/getCorpInfo', function ( req, res, next ) {
	...
	statementService.getCorpInfo( testCorpNum, function ( result ) {
...
router.get( '/updateCorpInfo', function ( req, res, next ) {
	...
	statementService.updateCorpInfo( testCorpNum, corpInfo, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/registContact', function ( req, res, next ) {
	...
	statementService.registContact( testCorpNum, contactInfo, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/getContactInfo', function ( req, res, next ) {
	...
	statementService.getContactInfo( testCorpNum, contactID, function ( result ) {
...
router.get( '/listContact', function ( req, res, next ) {
	...
	statementService.listContact( testCorpNum, function ( result ) {
...
router.get( '/updateContact', function ( req, res, next ) {
	...
	statementService.updateContact( testCorpNum, testUserID, contactInfo, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/paymentRequest', function ( req, res, next ) {
	...
	// 입금신청 객체 정보
	var PaymentForm = {
		settlerName: SettlerName, settlerEmail: SettlerEmail, notifyHP: NotifyHP, paymentName: PaymentName, settleCost: SettleCost,
	};
	// 팝빌회원 아이디
	var UserID = 'testkorea';
	
	statementService.paymentRequest( CorpNUm, PaymentForm, UserID, function ( result ) {
...
router.get( '/getSettleResult', function ( req, res, next ) {
	...
	statementService.getBulkResult( CorpNum, SettleCode, UserID, function ( result ) {
...
router.get( '/getPaymentHistory', function ( req, res, next ) {
	...
	statementService.getPaymentHistory( CorpNum, SDate, EDate, Page, PerPage, UserID, function ( result ) {
...
router.get( '/getUseHistory', function ( req, res, next ) {
	...
	statementService.getUseHistory( CorpNum, SDate, EDate, Page, PerPage, Order, UserID, function ( result ) {
...
router.get( '/refund', function ( req, res, next ) {
	...
	statementService.refund( CorpNum, RefundForm, UserID, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message, refundCode: result.refundCode,
		} );
	}, function ( Error ) {
		res.render( 'response', {
			path: req.path, code: Error.code, message: Error.message,
...
router.get( '/getRefundHistory', function ( req, res, next ) {
	...
	statementService.getRefundHistory( CorpNum, Page, PerPage, UserID, function ( result ) {
...
/**
 * 회원 탈퇴를 합니다.
 * https://developers.popbill.com/reference/statement/node/api/point#QuitMember
 */
router.get( '/quitMember', function ( req, res, next ) {
	...
	statementService.QuitMember( CorpNum, QuitReason, UserID, function ( result ) {
		res.render( 'response', {
			path: req.path, code: result.code, message: result.message,
		} );
	}, function ( Error ) {
...
router.get( '/getRefundableBalance', function ( req, res, next ) {
	...
	statementService.GetRefundableBalance( CorpNum, UserID, function ( result ) {
		res.render( 'Base/getRefundableBalance', {
			path: req.path, refundableBalance: result.refundableBalance,
		} );
	}, function ( Error ) {
		res.render( 'response', { path: req.path, code: Error.code, message: Error.message } );
	} );
...
router.get( '/getRefundInfo', function ( req, res, next ) {
	...
	statementService.GetRefundInfo( CorpNum, RefundCode, UserID, function ( result ) {
